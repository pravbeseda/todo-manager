...
module.exports = "  <script src=\"node_modules/bootbox/bootbox.js\"></script>\n\n  <nav class=\"navbar navbar-default\">\n    <div class=\"container\">\n      <div class=\"navbar-header\">\n        <a class=\"navbar-brand\" routerLink=\"\">Менеджер задач</a>\n      </div>\n      <div id=\"navbar\" class=\"navbar-collapse collapse\">\n        <ul class=\"nav navbar-nav navbar-right\">\n          <!-- Какой-то контент справа -->\n        </ul>\n      </div>\n    </div>\n  </nav>\n  <div class=\"container\">\n    <router-outlet></router-outlet>\n  </div>\n\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__task_edit_task_edit_component__ = __webpack_require__("../../../../../src/app/task-edit/task-edit.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tasks_list_tasks_list_component__ = __webpack_require__("../../../../../src/app/tasks-list/tasks-list.component.ts");
...
// Маршруты
var appRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_9__tasks_list_tasks_list_component__["a" /* TasksListComponent */] },
    { path: 'edit', component: __WEBPACK_IMPORTED_MODULE_7__task_edit_task_edit_component__["a" /* TaskEditComponent */] },
    { path: 'edit/:id', component: __WEBPACK_IMPORTED_MODULE_7__task_edit_task_edit_component__["a" /* TaskEditComponent */] },
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__task_edit_task_edit_component__["a" /* TaskEditComponent */],
            __WEBPACK_IMPORTED_MODULE_8__not_found_not_found_component__["a" /* NotFoundComponent */],
            __WEBPACK_IMPORTED_MODULE_9__tasks_list_tasks_list_component__["a" /* TasksListComponent */],
        ],
        imports: [
...
module.exports = "<form *ngIf=\"task\" (ngSubmit)=\"onSubmit()\" (ngCancel)=\"onCancel()\" class=\"form-horizontal\">\n  <input [(ngModel)]=\"task.id\" [ngModelOptions]=\"{standalone: true}\" type=\"hidden\">\n  <div class=\"form-group\">\n    <label for=\"inputTitle\" class=\"col-sm-2 control-label\">Название</label>\n    <div class=\"col-sm-10\">\n      <input [(ngModel)]=\"task.title\" [ngModelOptions]=\"{standalone: true}\" type=\"text\" class=\"form-control\" id=\"inputTitle\" placeholder=\"Название задачи\">\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputTitle\" class=\"col-sm-2 control-label\">Описание</label>\n    <div class=\"col-sm-10\">\n      <textarea [(ngModel)]=\"task.description\" [ngModelOptions]=\"{standalone: true}\" class=\"form-control\" rows=\"4\" placeholder=\"Описание\"></textarea>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputDate\" class=\"col-sm-2 control-label\">Срок исполнения</label>\n    <div class=\"col-sm-10\">\n      <input [(ngModel)]=\"task.date\" [ngModelOptions]=\"{standalone: true}\" type=\"date\" class=\"form-control\" id=\"inputDate\">\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <button type=\"submit\" class=\"btn btn-primary\">Готово</button>\n      <button type=\"cancel\" class=\"btn btn-default\">Отмена</button>\n    </div>\n  </div>\n</form>\n\n<div *ngIf=\"task == undefined\" class=\"alert alert-danger\" role=\"alert\" style=\"text-align: center\">Задача не найдена!</div>\n"
...
var TaskEditComponent = (function () {
    function TaskEditComponent(taskService, router, activateRoute) {
        this.taskService = taskService;
        this.router = router;
        this.activateRoute = activateRoute;
        this.task = new __WEBPACK_IMPORTED_MODULE_3__task__["a" /* Task */]();
...
TaskEditComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__task_service__["a" /* TaskService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__task_service__["a" /* TaskService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */]) === "function" && _c || Object])
], TaskEditComponent);
...
var TaskService = (function () {
    ...
    TaskService.prototype.loadTasksFromStorage = function () {
        this.tasks = this.ls.get('tasks')['items'] || [];
        this.lastId = this.ls.get('tasks')['lastId'] || 0;
    };
    TaskService.prototype.saveTasksToStorage = function () {
        this.ls.set('tasks', {
            'items': this.tasks,
            'lastId': this.lastId
        });
    ...
    TaskService.prototype.updateTask = function (id, values) {
    ...
    TaskService.prototype.getTaskById = function (id) {
        ...
        return this.tasks.filter(function (task) { return task.id === id; }).pop();
    };
    TaskService.prototype.toggleTaskComplete = function (task) {
        return this.updateTask(task.id, {
            complete: !task.complete
        });
    };
    TaskService.prototype.isExpired = function (task) {
        if (task.complete || !task.date || !__WEBPACK_IMPORTED_MODULE_2_moment__(task.date).isValid()) {
            return false;
        }
        var days = __WEBPACK_IMPORTED_MODULE_2_moment__(task.date).diff(__WEBPACK_IMPORTED_MODULE_2_moment__(), 'days');
        return (days < 0);
    };
    TaskService.prototype.isWarning = function (task) {
        if (task.complete || !task.date || !__WEBPACK_IMPORTED_MODULE_2_moment__(task.date).isValid()) {
            return false;
        }
        var days = __WEBPACK_IMPORTED_MODULE_2_moment__(task.date).diff(__WEBPACK_IMPORTED_MODULE_2_moment__(), 'days');
...
var TasksListComponent = (function () {
    ...
    TasksListComponent.prototype.removeTask = function (id) {
        this.taskService.deleteTaskById(id);
    };
    TasksListComponent.prototype.toggleTaskComplete = function (task) {
        this.taskService.toggleTaskComplete(task);
    };
    TasksListComponent.prototype.isExpired = function (task) {
        return this.taskService.isExpired(task);
    };
    TasksListComponent.prototype.isWarning = function (task) {
        return this.taskService.isWarning(task);
    };
    TasksListComponent.prototype.onSorted = function () {
        this.taskService.updateTasks(this.tasks);
    };
    TasksListComponent.prototype.dateDiff = function (date) {
